  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-black/55">Updates on your complaints, bills and notices.</p>
      </div>

      {error && <p className="mb-4 text-sm text-[var(--danger)]">{error}</p>}
      {notReady && (
        <p className="mb-4 text-sm text-[var(--alert)]">
          Notifications aren't live yet — this screen will populate automatically once they are.
        </p>
      )}
