...
- **MVP client:** responsive React web only (mobile browser + desktop). Do **not** build Flutter for MVP.
- **Stack:** Bun, Elysia, Drizzle, PostgreSQL, Redis, BullMQ, Azure Blob, MSG91, Resend, Firebase web push, Razorpay — as in Architecture.
